...
//                      $module_fields[$key] = $value;
	...
	$content.="<tr><td></td><td>";
	$content.="<p>";
	$content.="<input type='submit' class='wp-sugar-free-widget-area-submit' value='Submit' id='submit' name='submit'></p></td></tr>";
	$content.="<tr><td></td><td style='font-size:9px;float:right;'>Generated by <a target='_blank' href='http://www.smackcoders.com/wordpress-sugar-integration-automated-multi-web-forms-generator-pro.html'>WP-Sugar</a></td></tr></table>";
