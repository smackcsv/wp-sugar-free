...
<div class="sugar-free-messageBox" id="message-box" style="display:none;" ><b>Successfully Saved!</b></div>
	<form id="smack_wp_sugar_free_field_form"
		...
		if (! empty ( $allowedFields )) {
                ...
                <?php } 
                        $content .= '<div style="width:20%;float:left;"><h3 class="title">Field settings</h3></div><div style="width:80%;float:right;"><p>( Please use the short code <b> [sugarcrm_webtolead_WG]</b> in page or post )</p></div><br/><br/>
...
$imagepath = $contentUrl . '/plugins/wp-sugar-free/images/';
		...
		<input type="hidden" name="widget_field_posted"
			value="posted" />
